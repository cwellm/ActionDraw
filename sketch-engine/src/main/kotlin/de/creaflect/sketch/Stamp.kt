 ...
 */
class PaperGrain(val size: Int = 256, seed: Long = 7L, floor: Float = 0.35f) : AutoCloseable {
    val image: Image
    ...
    private fun noise(size: Int, seed: Long): FloatArray {
        ...
        val octaves = listOf(8 to 0.5f, 16 to 0.3f, 32 to 0.2f) // cells across the tile, weight
